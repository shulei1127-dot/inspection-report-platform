...
class LinuxDefaultParser:
    parser_name = "default-linux-parser"
    ...
    def parse(
        ...
        *,
        ...
        file_count, dir_count = _scan_extracted_dir(analysis_root)
        ...
        hostname_fallback = _derive_hostname(analysis_root, archive_name)
...
def _build_issues(
    ...
    *,
    ...
    issues.extend(_build_host_issues(host_parse_result, generated_at=generated_at))
